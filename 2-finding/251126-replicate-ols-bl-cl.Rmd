...
```{r import-data}
global_data <- read_rds("../1-data/2-processed/CANDOUR_data.rds")
global_data %>% 
  head() %>% 
...
# ggsave("./1-figure/res-CANDOUR-OLS.png", ols.plot)
...
# ggsave("./1-figure/res-CANDOUR-BL.png", bl.plot)
bl.plot
```
...
# ggsave("./1-figure/res-CANDOUR-CL.png", cl.plot)
cl.plot
```
...
ggsave("./1-figure/res-CANDOUR-BL+CL.png")
```
